...
sys.path.insert(0, os.path.abspath('../../pygeodata'))
...
# If true, '()' will be appended to :stat_func: etc. cross-reference text.
...
htmlhelp_basename = 'pygeodata_doc'
html_static_path = ['_static']
html_css_files = ['css.css']
